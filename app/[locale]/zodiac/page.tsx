  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-12">
      ...
      <div className="text-center max-w-3xl mx-auto space-y-4">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-panel border border-amber-200 dark:border-amber-800 text-amber-700 dark:text-amber-300 text-xs font-bold shadow-sm">
          ...
          <div key={z.slug} className="glass-card rounded-3xl p-6 flex flex-col justify-between space-y-4 group">
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-amber-500 to-orange-600 text-white flex items-center justify-center text-2xl font-bold shadow-md shadow-amber-500/20">
                  {z.symbol}
                </div>
              ...
              {/* Title & Dates */}
              <div>
                <h3 className="text-2xl font-black text-slate-900 dark:text-white group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors">
              ...
              <div className="flex flex-wrap gap-1.5 pt-2">
                {(locale === "id" ? z.traits_id : z.traits_en).slice(0, 3).map((trait, idx) => (
                  <span key={idx} className="px-2 py-0.5 rounded bg-amber-50 dark:bg-amber-950/60 text-amber-700 dark:text-amber-300 text-[10px] font-bold">
                    {trait}
                  </span>
                ))}
              </div>
            ...
            <div className="pt-3 border-t border-slate-100 dark:border-slate-800">
              <Link
                ...
                className="block text-center py-2 rounded-xl text-xs font-bold bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900 hover:bg-amber-600 dark:hover:bg-amber-400 transition-colors"
              >
