  ...
  return (
    <div className="w-full">
      ...
      <div className="text-center mb-8">
        ...
        <h1 className="text-2xl font-bold text-slate-900 mb-1">{t("registerTitle")}</h1>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                autoComplete="new-password"
                className={`w-full pl-10 pr-4 py-3 rounded-xl bg-white border text-slate-900 placeholder-slate-400 text-sm focus:outline-none focus:ring-2 transition-all duration-200 shadow-sm ${
