  ...
  return (
    <div className="w-full">
      ...
      <div className="mb-8 text-left">
        ...
        <TextReveal as="h1" className="text-4xl font-bold tracking-[-0.04em] text-[var(--color-ink)]">{t("loginTitle")}</TextReveal>
        <TextReveal as="p" delay={0.1} className="mt-2 text-base text-[var(--color-muted)]">{t("loginSubtitle")}</TextReveal>
      </div>
      ...
      <div className="border-t-2 border-teal-700 bg-[var(--color-surface)] py-8 sm:px-8">
        <form onSubmit={handleSubmit} className="space-y-5" id="login-form">
          ...
          <div className="space-y-1.5">
            <label htmlFor="login-email" className="block text-sm font-medium text-[var(--color-ink)]">
              {t("emailLabel")}
            </label>
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              <label htmlFor="login-password" className="block text-sm font-medium text-[var(--color-ink)]">
                {t("passwordLabel")}
              </label>
